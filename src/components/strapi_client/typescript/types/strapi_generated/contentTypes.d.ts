...
export interface ApiAppStateAppState extends Schema.SingleType {
  collectionName: 'app_states';
  info: {
...
export interface ApiBlogPostBlogPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    excerpt: Attribute.Text &
      ...
      Attribute.DefaultTo<'Domy\u015Blny opis'>;
...
export interface ApiWebsiteBuildWebsiteBuild extends Schema.CollectionType {
  collectionName: 'website_builds';
  info: {
  ...
  attributes: {
    state: Attribute.Enumeration<['started', 'finished', 'failed', 'aborted']> &
      Attribute.Required &
      Attribute.DefaultTo<'started'>;
    author: Attribute.String;
    build_time: Attribute.String;
